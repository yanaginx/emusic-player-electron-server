        ...
        if 150 < area < 1000:
            ...
            if isPausePlayMode(fingers, hand_label):
                ...
                if cntPausePlayModeFrame >= 50:
                    # (play/pause): x=492, y=848

                    # pyautogui.press('playpause')
                    pyautogui.click(x=492, y=848)
                    cntPausePlayModeFrame = 0
            else:
                cntPausePlayModeFrame = 0
            ...
            if isPreviousTrack(fingers, hand_label):
                ...
                if cntPrevTrackFrame >= 50:
                    # (previous track): x=445, y=848
                    # pyautogui.press('prevtrack')
                    pyautogui.click(x=445, y=848)
                    cntPrevTrackFrame = 0
            else:
                cntPrevTrackFrame = 0
            ...
            if isNextTrack(fingers, hand_label):
                ...
                if cntNextTrackFrame >= 50:
                    # (next track): x=548, y=848
                    # pyautogui.press('nexttrack')
                    pyautogui.click(x=548, y=848)
                    cntNextTrackFrame = 0
            else:
                cntNextTrackFrame = 0
